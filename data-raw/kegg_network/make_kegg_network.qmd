...
colnames(adjacency_matrix) <- paste0("kegg:", colnames(adjacency_matrix))
rownames(adjacency_matrix) <- paste0("kegg:", rownames(adjacency_matrix))

saveRDS(adjacency_matrix,"../pathway_similarity/KEGG_pathway_overlap_matrix.Rds")
